defmodule Mexpanel.PropertySerializerTest do
  ...
  test "it converts DateTime in UTC to right String" do
    ...
    assert PropertySerializer.serialize(input) == %{first_name: "Leif", perfect_date: "2018-04-25T13:36:45"}
  end
  ...
  test "it converts time in nested map" do
    ...
    assert PropertySerializer.serialize(input) == %{first_name: "Leif", perfects: %{date: "2018-04-25T13:36:45"}}
  end
end
